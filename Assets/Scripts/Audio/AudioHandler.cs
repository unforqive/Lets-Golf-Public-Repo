...
public class AudioHandler : MonoBehaviour
{
    ...
    [Space]
    public AudioClip chestRattleSFX;
    public AudioClip lootRewardSFX;
    ...
    public void PlayChestRattleSFX()
    {
        sfx.PlayOneShot(chestRattleSFX);
    }

    public void PlayLootRewardSFX()
    {
        sfx.PlayOneShot(lootRewardSFX);
    }

    public void PlayChestCloseSFX()
    {
        sfx.PlayOneShot(chestCloseSFX);
    }

    public void PlayPurchaseSFX()
    {
        sfx.PlayOneShot(purchaseSFX);
    }
}
